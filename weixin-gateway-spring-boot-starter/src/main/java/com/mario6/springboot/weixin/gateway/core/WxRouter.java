...
public class WxRouter {
    ...
    private List<Future<?>> executeRules(WxXmlMessage wxMessage, List<WxRouteRule> matchRules) {
    ...
    private void recordFutureTask(WxXmlMessage wxMessage, List<Future<?>> futureTasks) {
